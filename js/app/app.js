...
define([ 'jquery',
	...
	var data = {
		...
		rows = [{
		    ...
		    {prefix:'NULL',first:'Dobby',last:'NULL',gender:'m',height:23,weight:20,age:284,has_nose:'True'},
		    {prefix:'Ms.',first:'Luna',last:'Lovegood',gender:'f',height:68,weight:99,age:17,has_nose:'True'},
		    {prefix:'NULL',first:'Hagrid',last:'NULL',gender:'m',height:108,weight:553,age:45,has_nose:'True'},
		    {prefix:'Dark Lord',first:'Tom',last:'Riddle',gender:'m',height:74,weight:144,age:48,has_nose:'False'},
		    {prefix:'"Moaning"',first:'Myrtle',last:'NULL',gender:'f',height:65,weight:0,age:106,has_nose:'NULL'}]
	};
